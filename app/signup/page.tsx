...
import { Eye, EyeOff, ChefHat, Building2 } from 'lucide-react';
      ...
      <div className="relative w-96 p-10 bg-gray-900/85 rounded-2xl shadow-2xl shadow-orange-500/15 backdrop-blur-md z-10 border border-gray-800">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">
            Start optimizing your restaurant with AI-powered intelligence.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative group">
            ...
            <input
              ...
              required
              className="relative w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 text-sm"
            />
          </div>
          ...
          <div className="relative group">
            ...
            <select
              ...
              className="relative w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 text-sm"
            >
          ...
          <div className="relative group">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-3 pr-12 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 text-sm"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 bg-gradient-to-r from-orange-400 to-orange-600 text-black font-semibold rounded-lg hover:shadow-lg hover:shadow-orange-500/25 transform hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none mt-6"
          >
            {isLoading ? (
