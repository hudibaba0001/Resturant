# Test New Sections API
$BaseUrl = "https://resturant-two-xi.vercel.app"
$RestaurantId = "64806e5b-714f-4388-a092-29feff9b64c0"

Write-Host "Testing New Sections API..." -ForegroundColor Cyan
Write-Host "Base URL: $BaseUrl" -ForegroundColor Gray
Write-Host "Restaurant ID: $RestaurantId" -ForegroundColor Gray
Write-Host ""

# Test 1: Create a new section using the route the UI expects
Write-Host "Creating new section 'Main Course' via /api/dashboard/sections..." -ForegroundColor Yellow
...
try {
    $response = Invoke-RestMethod -Method POST -Uri "$BaseUrl/api/dashboard/sections" `
